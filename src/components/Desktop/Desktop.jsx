...
export function Desktop() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[80px] sm:top-1/2 right-4 sm:right-8 sm:-translate-y-1/2 flex flex-col gap-5 sm:gap-4 scale-[0.85] sm:scale-[0.80] origin-top-right sm:origin-right z-10">
